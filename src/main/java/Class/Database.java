...
//쿼리 날리기
	...
	System.out.println("selectquery:"+queryResult);
	return queryResult;
}
	//쿼리 날리기
		...
		ResultSet rs = null;
		String queryResult="";
		String SQL = "SELECT * FROM "+tableName+" WHERE car_number = "+car_number+" ORDER BY id DESC LIMIT 1";
		try {
...
// 새로운 차 정보 입력
	...
	//출차정보 조회
		public static String selectEnterTime(String car_number) throws SQLException {
